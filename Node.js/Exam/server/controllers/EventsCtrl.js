...
module.exports = {
    ...
    getActiveEvents: function getActiveEvents(req, res) {
    ...
    getPassedEvents: function getPassedEvents(req, res) {
    ...
    getJoinedEvents: function getJoinedEvents(req, res) {
        var username = req.params.username;
    ...
    getPassedUserEvents: function getPassedUserEvents(req, res) {
        var username = req.params.username;

        events
            .passedByUser(username)
            .exec(function(err, collection) {
                if (err) {
                    return res.status(400).send('Events could not be loaded: ' + err);
                }
