...
namespace Northwind
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<NameAndIncome> uspSupplierIncome(string companyName, string startDate, string endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<NameAndIncome>("uspSupplierIncome", companyNameParameter, startDateParameter, endDateParameter);
        }
